...
* [Konfetti](https://github.com/DanielMartinus/Konfetti) ⭐ 3,384 | 🐛 27 | 🌐 Kotlin | 📅 2025-08-21 - 轻量五彩纸屑粒子系统🔥🔥🔥🔥🔥
...
* [koin](https://github.com/Ekito/koin) ⭐ 10,014 | 🐛 81 | 🌐 Kotlin | 📅 2026-06-15 - 简明实用的 Kotlin 依赖注入框架 🔥🔥🔥🔥🔥
* [koin](https://github.com/Ekito/koin) ⭐ 10,014 | 🐛 81 | 🌐 Kotlin | 📅 2026-06-15 - 没有代理，没有代码生成，没有反射；用简洁实用的方式编写依赖注入的轻量库。🔥🔥🔥🔥🔥
...
* [http4k](https://github.com/http4k/http4k) ⭐ 2,784 | 🐛 43 | 🌐 Kotlin | 📅 2026-08-12 - HTTP 工具包 🔥🔥🔥🔥
...
* [detekt](https://github.com/arturbosch/detekt) ⭐ 7,026 | 🐛 195 | 🌐 MDX | 📅 2026-08-12 - 静态代码分析工具 🔥🔥🔥🔥🔥
...
* [kotlinx.serialization](https://github.com/Kotlin/kotlinx.serialization) ⭐ 5,940 | 🐛 319 | 🌐 Kotlin | 📅 2026-08-11 - 跨平台序列化库。🔥🔥🔥🔥🔥
...
* [shadowsocks-android](https://github.com/shadowsocks/shadowsocks-android) ⭐ 36,760 | 🐛 77 | 🌐 Kotlin | 📅 2026-08-09 - shadowsocks 客户端 🔥🔥🔥🔥🔥
...
* [Lightning-Browser](https://github.com/anthonycr/Lightning-Browser) ⭐ 2,426 | 🐛 350 | 🌐 Kotlin | 📅 2026-08-13 - （闪电浏览器）是体积小巧的高性能浏览器 🔥🔥🔥🔥

* [CatchUp](https://github.com/hzsweers/CatchUp) ⭐ 2,096 | 🐛 37 | 🌐 Kotlin | 📅 2026-08-13 - 聚合Hacker News、Reddit、Medium等平台的热门信息的 APP🔥🔥🔥🔥
