...
* [koin](https://github.com/Ekito/koin) ⭐ 10,020 | 🐛 74 | 🌐 Kotlin | 📅 2026-09-20 - 简明实用的 Kotlin 依赖注入框架 🔥🔥🔥🔥🔥
* [koin](https://github.com/Ekito/koin) ⭐ 10,020 | 🐛 74 | 🌐 Kotlin | 📅 2026-09-20 - 没有代理，没有代码生成，没有反射；用简洁实用的方式编写依赖注入的轻量库。🔥🔥🔥🔥🔥
